...
window.Mousetrap=Mousetrap,"function"==typeof define&&define.amd&&define(Mousetrap)}(window,document);var applicationVotedevaleur=angular.module("votedevaleur",["ngRoute"]);applicationVotedevaleur.config(function($routeProvider,$locationProvider){$locationProvider.html5Mode(!0),$routeProvider.when("/",{templateUrl:"vues/question.html",controller:"questionControleur"})}),applicationVotedevaleur.controller("questionControleur",["$scope","$http",function(scope){scope.message="alors ce message"}]);